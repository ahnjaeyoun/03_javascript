...
function getInnerText() {
    ...
    // HTML 문서 내에서 아이디가 "tst1"인 요소를 얻어와
    // test1 변수에 대입
...
function fnPrompt() {
    ...
    const promptReult = document.getElementById("promptResult");

    if(input != null) {
        promptReult.innerText = input + "님 환영합니다";
    } else {
        promptReult.innerText = "이름을 입력해주세요";
    }
}